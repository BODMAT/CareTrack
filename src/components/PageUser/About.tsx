    ...
    return (
        <motion.section
            ...
            <div className="flex-1/2 grow-0 select-none fontText leading-6 tracking-wide max-[800px]:text-center transitioned text-[var(--color-text)] ">
                ...
                <p className='md:indent-5 mb-4'>Цей вебсайт — система обліку догляду за тваринами, яка дозволяє двом категоріям користувачів (звичайним користувачам і адміністратору) взаємодіяти з базою даних тварин, нарядів та догляду. Звичайні користувачі можуть переглядати власні наряди на обслуговування тварин, бачити детальну інформацію про кожну тварину, а також додавати або редагувати заявки на нові роботи — усе це через простий та інтуїтивний інтерфейс з модальними вікнами. Адміністратор має розширений доступ: він може бачити всі записи користувачів,  видаляти їх та слідкувати за всією базою.</p>
            </div>
